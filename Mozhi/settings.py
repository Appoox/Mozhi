"""
Django settings for Mozhi project.
...
RUNSERVERPLUS_SERVER_ADDRESS_PORT = env("HOST_PORT")

HOSTNAME = 'localhost:9797'
ALLOWED_HOSTS = ["*"]
...
WSGI_APPLICATION = 'Mozhi.wsgi.application'
